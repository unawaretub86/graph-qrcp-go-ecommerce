...
const file_catalog_catalog_proto_rawDesc = "" +
	...
	"\aCatalog\x12>\n" +
	"\vPostProduct\x12\x16.pb.PostProductRequest\x1a\x17.pb.PostProductResponse\x12G\n" +
	"\x0eGetProductByID\x12\x19.pb.GetProductByIDRequest\x1a\x1a.pb.GetProductByIDResponse\x12>\n" +
...
var file_catalog_catalog_proto_depIdxs = []int32{
	...
	1, // 3: pb.Catalog.PostProduct:input_type -> pb.PostProductRequest
	3, // 4: pb.Catalog.GetProductByID:input_type -> pb.GetProductByIDRequest
	5, // 5: pb.Catalog.GetProducts:input_type -> pb.GetProductsRequest
	2, // 6: pb.Catalog.PostProduct:output_type -> pb.PostProductResponse
	4, // 7: pb.Catalog.GetProductByID:output_type -> pb.GetProductByIDResponse
	6, // 8: pb.Catalog.GetProducts:output_type -> pb.GetProductsResponse
