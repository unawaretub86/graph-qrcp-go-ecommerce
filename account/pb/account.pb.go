...
type PotsAccountRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *PotsAccountRequest) Reset() {
	*x = PotsAccountRequest{}
	mi := &file_account_account_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PotsAccountRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PotsAccountRequest) ProtoMessage() {}

func (x *PotsAccountRequest) ProtoReflect() protoreflect.Message {
	mi := &file_account_account_proto_msgTypes[7]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PotsAccountRequest.ProtoReflect.Descriptor instead.
func (*PotsAccountRequest) Descriptor() ([]byte, []int) {
	return file_account_account_proto_rawDescGZIP(), []int{7}
}

type PotsAccountResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *PotsAccountResponse) Reset() {
	*x = PotsAccountResponse{}
	mi := &file_account_account_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PotsAccountResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PotsAccountResponse) ProtoMessage() {}

func (x *PotsAccountResponse) ProtoReflect() protoreflect.Message {
	mi := &file_account_account_proto_msgTypes[8]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PotsAccountResponse.ProtoReflect.Descriptor instead.
func (*PotsAccountResponse) Descriptor() ([]byte, []int) {
...
const file_account_account_proto_rawDesc = "" +
	...
	"\bAccounts\x18\x01 \x03(\v2\v.pb.AccountR\bAccounts\"\x14\n" +
	"\x12PotsAccountRequest\"\x15\n" +
	"\x13PotsAccountResponse2\xcd\x01\n" +
...
var file_account_account_proto_goTypes = []any{
	...
	(*PotsAccountRequest)(nil),  // 7: pb.PotsAccountRequest
	(*PotsAccountResponse)(nil), // 8: pb.PotsAccountResponse
}
